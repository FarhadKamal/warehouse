...
$requisition = join_apv_requisition_table();
else if($usr_lvl == 4){
  $requisition = join_requisition_sub_approval_table();
  $atype=2;
}
              ...
              <tr>
                ...
                <td class="text-center">
                  <div>
                    ...
                    <?php
                    if ($req['approve_status'] == 0  and $req['cancel_status'] == 0 and $atype==1) {
                    ?>
                    ...
                    <?php
                    if ($req['sub_approved_status'] == 0  and $req['cancel_status'] == 0 and $atype==2) {
                    ?>
                      <a href="edit_requisition.php?id=<?php echo (int)$req['id']; ?>" class="btn btn-info btn-xs" title="Process" data-toggle="tooltip">
                        <span class="glyphicon glyphicon-ok-sign"></span>
                      </a>
                    ...
                    <?php
                    if ($req['approve_status'] == 0 and $req['cancel_status'] == 0  and  in_array( $_SESSION['user_id'], array(4,0)) ) {
                    ?>
