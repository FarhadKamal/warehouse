  ...
  <div class="panel panel-default">
    <div class="panel-heading clearfix">
     <div class="pull-right">
       <a href="add_requisition.php" class="btn btn-primary">New</a>
     </div>
   </div>
          ...
          <tr>
            ...
            <td class="text-center">
              <div>
                ...
                { 
                  ?>
                  <a href="edit_requisition.php?id=<?php echo (int)$req['id'];?>" class="btn btn-info btn-xs"  title="Edit" data-toggle="tooltip">
                ...
                { 
                  ?>
                  <a href="cancel_requisition.php?id=<?php echo (int)$req['id'];?>" class="btn btn-danger btn-xs"  title="Delete" onclick="return confirm('Are you sure you want to cancel? Requisition ID:<?php echo (int)$req["id"];?> ');" data-toggle="tooltip">
                ...
                <?php } ?>
                 ...
                 <?php
                if($req['approve_status']==1 and $req['cancel_status']==0 and $req['complete_status']==0 and $req['submit_status']==1)
                { 
                  ?>
                  <a href="complete_requisition.php?id=<?php echo (int)$req['id'];?>" class="btn btn-warning btn-xs"  title="Complete" onclick="return confirm('Are you sure you want to complete? Requisition ID:<?php echo (int)$req["id"];?> ');" data-toggle="tooltip">
