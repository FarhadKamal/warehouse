...
if (isset($_POST['submit'])) {
  ...
  if (empty($errors)) {
    ...
    $results      = find_issue_by_dates($start_date, $end_date, $location, $product, $cost,   $com_id);
  } else {
...
<body>
  <input type="button" class="btn btn-sm" onclick="tableToExcel('excel', 'Issue History Report', 'IssueReport.xls')" value="Export to Excel" />
  <?php if ($results) : ?>
