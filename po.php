    ...
    <div class="panel panel-default">
      <div class="panel-heading clearfix">
        <div class="pull-right">
          <a href="add_po.php" class="btn btn-primary">New</a>
        </div>
      </div>
                  ...
                  <div>
                    ...
                    if ($g['cancel_status'] == 0 and $g['submit_status'] == 0) {
                      if ($g['req_id'] == null) { ?>
                        ...
                        <a href="edit_po.php?id=<?php echo (int)$g['id']; ?>" class="btn btn-info btn-xs" title="Edit" data-toggle="tooltip">
                      ...
                      if ($g['cancel_status'] == 0 and $g['submit_status'] == 0) {
                      ?>
                        <a href="delete_po.php?id=<?php echo (int)$g['id']; ?>" class="btn btn-danger btn-xs" title="Delete" onclick="return confirm('Are you sure you want to cancel? PO No:<?php echo (int)$g["id"]; ?> ');" data-toggle="tooltip">
